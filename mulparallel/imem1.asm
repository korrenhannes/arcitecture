	# Core 1: rows 4-7 of 16x16 matrix multiply
	add $r2,  $zero, $imm, 4		# i = start row 4
	add $r15, $zero, $imm, 8		# end row (exclusive)
...
loop_k:
	...
	add $r6,  $zero, $imm, 0x448		# start eviction addr for row4 second-block (0x248 + 0x200)
	add $r7,  $zero, $imm, 4		# rows to evict (4-7)
