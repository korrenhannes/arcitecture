	# Core 0: rows 0-3 of 16x16 matrix multiply
	add $r2,  $zero, $imm, 0		# i = start row 0
	add $r15, $zero, $imm, 4		# end row (exclusive)
...
loop_k:
	...
	add $r6,  $zero, $imm, 0x408		# start eviction addr for row0 second-block (0x208 + 0x200)
	add $r7,  $zero, $imm, 4		# rows to evict (0-3)
